...
export class Client extends ContractClient {
  static async deploy<T = Client>(
    ...
    return ContractClient.deploy(
      { admin, decimal, name, symbol, total_supply, owner },
      options,
    );
  }
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([
        "AAAAAAAAAAAAAAANX19jb25zdHJ1Y3RvcgAAAAAAAAYAAAAAAAAABWFkbWluAAAAAAAAEwAAAAAAAAAHZGVjaW1hbAAAAAAEAAAAAAAAAARuYW1lAAAAEAAAAAAAAAAGc3ltYm9sAAAAAAAQAAAAAAAAAAx0b3RhbF9zdXBwbHkAAAALAAAAAAAAAAVvd25lcgAAAAAAABMAAAAA",
