...
- 🪙 **Token Launch**: Create and deploy tokens with custom metadata stored on IPFS
- 💧 **Liquidity Pools**: Add and remove liquidity from trading pairs with proportional calculations
- 🪙 **LP Token Issuance**: Automatically receive Liquidity Provider (LP) tokens when adding liquidity, representing your ownership share in the pool
- 💰 **Fee Earnings**: Earn trading fees proportional to your LP token holdings
- 📊 **LP Token Management**: View and manage your LP token balances across all pools
- 🔄 **Token Swaps**: Trade tokens using AMM pricing with real-time output calculations
- 📊 **Portfolio Tracking**: View token balances, LP token holdings, and liquidity positions across all pools
- 📈 **Market Data**: Real-time price, market cap, volume, and 24h change calculations from pool reserves
- 🔐 **Wallet Integration**: Connect with Stellar wallets seamlessly via Scaffold Stellar's wallet system
- 📱 **Responsive UI**: Modern, mobile-friendly interface built with Tailwind CSS
- 🎨 **Dark Theme**: Beautiful dark mode interface with Stellar Design System components
...
│   ├── tokenfactory/      # Token factory contract
│   ├── poolfactory/       # Pool factory contract
│   ├── token/             # Token contract implementation
│   ├── tokenlaunch/       # Token launch contract
│   └── pool/              # Pool contract implementation
├── packages/               # Auto-generated TypeScript contract clients (Scaffold Stellar)
│   ├── tokenfactory/      # Generated tokenfactory client
│   ├── poolfactory/       # Generated poolfactory client
│   ├── token/             # Generated token client
│   ├── tokenlaunch/       # Generated tokenlaunch client
│   └── pool/              # Generated pool client
├── src/
...
│   │   ├── Launch.tsx    # Token launch page
│   │   ├── Swap.tsx      # Token swap page
│   │   ├── Liquidity.tsx # Liquidity management page
│   │   ├── Portfolio.tsx # Portfolio tracking page
│   │   └── Minter.tsx    # Token faucet/minter page
│   ├── contracts/        # Contract client imports and utilities
│   │   ├── util.ts       # Network configuration (Scaffold Stellar)
│   │   └── ...           # Contract client imports
│   ├── hooks/            # Custom React hooks
│   │   └── useWallet.ts  # Wallet hook (Scaffold Stellar)
│   ├── providers/        # React context providers
│   │   └── WalletProvider.tsx  # Wallet provider (Scaffold Stellar)
│   └── lib/              # Utility functions
│       ├── contract-addresses.ts  # Contract address constants
│       ├── pinata.ts     # IPFS/Pinata integration
│       └── ...           # Other utilities
├── environments.toml     # Scaffold Stellar environment configuration
├── deployment-testnet.json  # Testnet deployment information
